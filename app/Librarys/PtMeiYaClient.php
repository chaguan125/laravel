...
class PtMeiYaClient
{
    private $http;
    private $type;
    private $appId = '1603699621009';
    private $appSecret = 'e44883c2f9604d9f84cdc8f2d4f63909';
    ...
    public function __construct($createMchId,$sendMchId)
    {
...
//        $this->sendMchId = '1242800802';
        if($this->type == 'P'){
            $this->createMchId = $createMchId;
            $this->sendMchId = $sendMchId;
        }
        $base = [
//            'D' => 'http://dev.promotion.miyapay.com', // 测试环境
            'D' => 'http://test.promotion.miyapay.com',
     ...
     * @return void
     */
    public function commonSend(string $openid, string $stockId, string $outBizNo)
    {
        try {
